...
#define MAX_SEND_SIZE 0x1FFFFE         // max size of output buffer (from 0x0FFFFE to 0x1FFFFE)
#define MAX_SEND_FILL_SIZE 0x15FFFE    // on this level, incoming data is blocked (from 0x0AFFFF to 0x15FFFE)
#define MAX_SEND_UNBLOCK_SIZE 0x07FFFFE // under this level it's unblocked again (from 0x07FFFF to 0x07FFFFE)
